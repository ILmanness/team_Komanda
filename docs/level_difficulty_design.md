...
|---|---|---|---|
| `0.1` | `2026-09-18` | Создана отдельная спецификация сложности; параметры Easy/Normal/Hard и Training вынесены из Scoring | `DRAFT` |
| `1.0` | `TBD` | Утверждена конфигурация MVP и тестовая матрица | `TBD` |
