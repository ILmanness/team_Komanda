...
Статус реализации: БД, миграция и очистка реализованы. Backend и frontend —
инфраструктурные каркасы-заглушки. AI по умолчанию возвращает фиксированный mock-ответ;
...
хеш до сохранения пользователя; проверка входа должна отклонять NULL. Endpoint'ы регистрации,
входа и сброса пароля ещё не реализованы. Хеш не возвращают клиенту и не пишут в логи.
