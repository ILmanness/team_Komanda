...
| Backend | FastAPI: авторизация, каталог, игровые сессии, движок и ходы через WebSocket |
| Frontend | React-интерфейс: тренировки, сюжетные миссии, свой диалог, история разговоров, база знаний и авторизация |
